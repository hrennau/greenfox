...
declare function f:getRequiredBindings($potentialBindings as xs:string*, 
    ...
    let $reqBindings := (
        ...
        $component/(@validatorXPath, gx:validatorXPath)/i:determineRequiredBindingsXPath(., $potentialBindings),        
        $component/(@validatorFoxpath, gx:validatorFoxpath)/i:determineRequiredBindingsFoxpath(., $potentialBindings),
